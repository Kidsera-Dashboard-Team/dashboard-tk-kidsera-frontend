                ...
                <ion-row class="ion-justify-content-between">
                    <ion-col size="3" size-xl="6">
                        <ion-title class="d-none d-xl-inline-block" size="small"><span
                                style="opacity: 50%;">Pages</span> / Tambah Fasilitas Sarana & Prasarana <br> <span
                                style="font-size: 18px; letter-spacing: 2.5px;">Tambah Fasilitas Sarana & Prasarana</span>
                        </ion-title>
                    </ion-col>
                        ...
                        <ion-card class="mt-4 p-3 rounded text-center card-form">
                            ...
                            <ion-card-content class="d-grid gap-3">
                                ...
                                <ion-item fill="outline">
                                    ...
                                    <ion-input placeholder="Masukkan Fasilitas" required></ion-input>
                                </ion-item>
                                <ion-item fill="outline">
