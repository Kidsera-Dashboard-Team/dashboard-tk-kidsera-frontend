                ...
                <ion-row class="ion-justify-content-between">
                    <ion-col size="3">
                        <ion-title class="d-none d-lg-inline-block" size="small"><span style="opacity: 50%;">Pages</span> /
                            Rombongan Belajar <br> <span style="font-size: 18px; letter-spacing: 2px;">Rombongan Belajar</span>
                        </ion-title>
                    </ion-col>
                ...
                <ion-card-content>
                    <ion-grid>
                        <div class="ion-justify-content-evenly container" style="flex-wrap: wrap; display: flex;">
                            <div onclick="window.location='/pages/rombonganbelajar/TahunAjaranRombonganBelajar';" class="card-content" style="width: 30%; margin: 0;">
