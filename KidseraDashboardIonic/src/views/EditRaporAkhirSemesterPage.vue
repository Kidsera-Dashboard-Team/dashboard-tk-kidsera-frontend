...
export default defineComponent({
  ...
  props: ["tahun", "kelas", "id_siswa", "periode", "semester"],
  setup() {
    ...
    async submitForm() {
      ...
      if (!result) {
        ...
        const json = JSON.stringify({
          aaa: this.formData.aaa,
          aab: this.formData.aab,
          aac: this.formData.aac,
          aad: this.formData.aad,
          aae: this.formData.aae,
          aba: this.formData.aba,
          abb: this.formData.abb,
          abc: this.formData.abc,
          baa: this.formData.baa,
          bab: this.formData.bab,
          bac: this.formData.bac,
          bad: this.formData.bad,
          bba: this.formData.bba,
          bbb: this.formData.bbb,
          bbc: this.formData.bbc,
          bbd: this.formData.bbd,
          bbe: this.formData.bbe,
          bbf: this.formData.bbf,
          bbg: this.formData.bbg,
          bca: this.formData.bca,
          bcb: this.formData.bcb,
          bcc: this.formData.bcc,
          caa: this.formData.caa,
          cab: this.formData.cab,
          cac: this.formData.cac,
          cad: this.formData.cad,
          cba: this.formData.cba,
          cbb: this.formData.cbb,
          cbc: this.formData.cbc,
          cbd: this.formData.cbd,
          cbe: this.formData.cbe,
          cbf: this.formData.cbf,
          cbg: this.formData.cbg,
          cca: this.formData.cca,
          ccb: this.formData.ccb,
          ccc: this.formData.ccc,
          ccd: this.formData.ccd,
          cce: this.formData.cce,
          ccf: this.formData.ccf,
          daa: this.formData.daa,
          dab: this.formData.dab,
          dac: this.formData.dac,
          dba: this.formData.dba,
          dbb: this.formData.dbb,
          dbc: this.formData.dbc,
          dbd: this.formData.dbd,
          dbe: this.formData.dbe,
          dbf: this.formData.dbf,
          dca: this.formData.dca,
          dcb: this.formData.dcb,
          dcc: this.formData.dcc,
          dcd: this.formData.dcd,
          eaa: this.formData.eaa,
          eab: this.formData.eab,
          eac: this.formData.eac,
          eba: this.formData.eba,
          ebb: this.formData.ebb,
          ebc: this.formData.ebc,
          ebd: this.formData.ebd,
          eca: this.formData.eca,
          ecb: this.formData.ecb,
          ecc: this.formData.ecc,
          ecd: this.formData.ecd,
          ece: this.formData.ece,
          ecf: this.formData.ecf,
          ecg: this.formData.ecg,
          ech: this.formData.ech,
          eci: this.formData.eci,
          faa: this.formData.faa,
          fab: this.formData.fab,
          fac: this.formData.fac,
          fad: this.formData.fad,
          fae: this.formData.fae,
          faf: this.formData.faf,
  ...
  mounted: function () {
    axios
      ...
      .then((response) => {
        ...
        this.formData.aab = this.results[0][0].b;
        this.formData.aac = this.results[0][0].c;
        this.formData.aad = this.results[0][0].d;
        this.formData.aad = this.results[0][0].d;
        this.formData.aae = this.results[0][0].e;
        this.formData.aba = this.results[0][1].a;
        this.formData.abb = this.results[0][1].b;
        this.formData.abc = this.results[0][1].c;
        this.formData.baa = this.results[1][0].a;
        this.formData.bab = this.results[1][0].b;
        this.formData.bac = this.results[1][0].c;
        this.formData.bad = this.results[1][0].d;
        this.formData.bba = this.results[1][1].a;
        this.formData.bbb = this.results[1][1].b;
        this.formData.bbc = this.results[1][1].c;
        this.formData.bbd = this.results[1][1].d;
        this.formData.bbe = this.results[1][1].e;
        this.formData.bbf = this.results[1][1].f;
        this.formData.bbg = this.results[1][1].g;
        this.formData.bca = this.results[1][2].a;
        this.formData.bcb = this.results[1][2].b;
        this.formData.bcc = this.results[1][2].c;
        this.formData.caa = this.results[2][0].a;
        this.formData.cab = this.results[2][0].b;
        this.formData.cac = this.results[2][0].c;
        this.formData.cad = this.results[2][0].d;
        this.formData.cba = this.results[2][1].a;
        this.formData.cbb = this.results[2][1].b;
        this.formData.cbc = this.results[2][1].c;
        this.formData.cbd = this.results[2][1].d;
        this.formData.cbe = this.results[2][1].e;
        this.formData.cbf = this.results[2][1].f;
        this.formData.cbg = this.results[2][1].g;
        this.formData.cca = this.results[2][2].a;
        this.formData.ccb = this.results[2][2].b;
        this.formData.ccc = this.results[2][2].c;
        this.formData.ccd = this.results[2][2].d;
        this.formData.cce = this.results[2][2].e;
        this.formData.ccf = this.results[2][2].f;
        this.formData.daa = this.results[3][0].a;
        this.formData.dab = this.results[3][0].b;
        this.formData.dac = this.results[3][0].c;
        this.formData.dba = this.results[3][1].a;
        this.formData.dbb = this.results[3][1].b;
        this.formData.dbc = this.results[3][1].c;
        this.formData.dbd = this.results[3][1].d;
        this.formData.dbe = this.results[3][1].e;
        this.formData.dbf = this.results[3][1].f;
        this.formData.dca = this.results[3][2].a;
        this.formData.dcb = this.results[3][2].b;
        this.formData.dcc = this.results[3][2].c;
        this.formData.dcd = this.results[3][2].d;
        this.formData.eaa = this.results[4][0].a;
        this.formData.eab = this.results[4][0].b;
        this.formData.eac = this.results[4][0].c;
        this.formData.eba = this.results[4][1].a;
        this.formData.ebb = this.results[4][1].b;
        this.formData.ebc = this.results[4][1].c;
        this.formData.ebd = this.results[4][1].d;
        this.formData.eca = this.results[4][2].a;
        this.formData.ecb = this.results[4][2].b;
        this.formData.ecc = this.results[4][2].c;
        this.formData.ecd = this.results[4][2].d;
        this.formData.ece = this.results[4][2].e;
        this.formData.ecf = this.results[4][2].f;
        this.formData.ecg = this.results[4][2].g;
        this.formData.ech = this.results[4][2].h;
        this.formData.eci = this.results[4][2].i;
        this.formData.faa = this.results[5][0].a;
        this.formData.fab = this.results[5][0].b;
        this.formData.fac = this.results[5][0].c;
        this.formData.fad = this.results[5][0].d;
        this.formData.fae = this.results[5][0].e;
        this.formData.faf = this.results[5][0].f;
        this.formData.text1 = this.results[6][0].text1;
        this.formData.text2 = this.results[6][0].text2;
        this.formData.text3 = this.results[6][0].text3;
        this.formData.text4 = this.results[6][0].text4;
        this.formData.text5 = this.results[6][0].text5;
        this.formData.text6 = this.results[6][0].text6;
