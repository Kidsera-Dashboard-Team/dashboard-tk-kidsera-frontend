            ...
            <ion-card class="rounded card-content">
                ...
                <ion-card-content>
                    <ion-grid>
                        <ion-row>
                            <ion-col>
                                <ion-card onclick="window.location='/pages/rombonganbelajar/detail';" class="card-content-judul">
                                    <ion-card-content class="text-center" style="margin: 70px;">
                                        <ion-card-title>TK A</ion-card-title>
                                    </ion-card-content>
                                </ion-card>
                            </ion-col>
                            <ion-col>
                                <ion-card class="card-content-judul">
                                    <ion-card-header class="text-center" style="margin: 70px;">
                                        <ion-card-title>TK B</ion-card-title>
                                    </ion-card-header>
                                </ion-card>
                            </ion-col>
                        </ion-row>
