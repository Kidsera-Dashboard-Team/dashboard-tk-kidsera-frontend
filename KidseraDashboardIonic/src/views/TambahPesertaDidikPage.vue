                ...
                <ion-row class="ion-justify-content-between">
                    <ion-col size="3" size-xl="6">
                        <ion-title class="d-none d-xl-inline-block" size="small"><span
                                style="opacity: 50%;">Pages</span> / Peserta Didik <br> <span
                                style="font-size: 18px; letter-spacing: 3.5px;">Peserta Didik</span>
                        </ion-title>
                    </ion-col>
                        ...
                        <ion-row class="ion-justify-content-center row-button">
                            ...
                            <ion-col size="6" size-sm="2">
                                <a class="btn btn-success" role="button"
                                    href="javascript: doSomethingForAddSarprasFasilitas()" @click="submitForm()">Tambah</a>
                            </ion-col>
                        </ion-row>
                    </div>
                </ion-card-content>
